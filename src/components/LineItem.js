...
class LineItem extends Component {
    ...
    render() {
        const validationState = (this.props.validationStates.description && this.props.validationStates.amount) ? 'success' : 'error';
        return <div><FormGroup key={this.props.idx} controlId={`${this.props.idx}`}
            validationState={validationState} >
            <Col smOffset={2} sm={7} md={7} xs={7} lg={7}>
                <FormControl type="text" placeholder="description" value={this.props.description}
